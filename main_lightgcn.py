...
if __name__ == '__main__':
    ...
    """build dataset"""
    train_cf, test_cf, user_dict, n_params, graph, [adj_mat, ui_mat, iu_mat], adj_mean_mat = load_data(args)
    ...
    """define model"""
    model = LightGCN(n_params, args, adj_mean_mat).to(device)
    print(model)
    """define optimizer"""
